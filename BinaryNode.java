...
public class BinaryNode<T> {
    ...
    protected BinaryNode<T> up = null;
     ...
     */
    public BinaryNode(T value) { this.entry = value; }
    ...
    public boolean isRightChild() {
        return this.up() != null && this.up().downRight() == this;
    }
    ...
    public String toLevelOrderString() {
        ...
        Queue<BinaryNode<T>> nodeList = new LinkedList<>();
        ...
        while (!nodeList.isEmpty()) {
            ...
            if (nodeList.peek().downLeft() != null) {
                nodeList.add(nodeList.peek().downLeft());
            }
            // if it exists, add the right child of the head of the queue to the queue
            if (nodeList.peek().downRight() != null) {
                nodeList.add(nodeList.peek().downRight());
            }
    ...
    public String toInOrderString() {
        ...
        while (stack.peek().downLeft() != null) {
            stack.push(stack.peek().downLeft());
        }
